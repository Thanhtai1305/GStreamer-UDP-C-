...
int main(int argc, char *argv[]) {
    ...
    if (mode == "case1") {
        ...
        if (role == "sender") {
            int result = start_sender();
            if (result != 0) {
                std::cerr << "Failed to run sender for case1" << std::endl;
                return result;
            }
        }
        else if (role == "receiver") {
            int result = start_receiver();
            if (result != 0) {
                std::cerr << "Failed to run receiver for case1" << std::endl;
                return result;
            }
        }
        else {
        ...
        if (role == "sender") {
            int result = start_sender_case2();
            if (result != 0) {
                std::cerr << "Failed to run sender for case2" << std::endl;
                return result;
            }
        }
        else if (role == "receiver") {
            int result = start_receiver_case2();
            if (result != 0) {
                std::cerr << "Failed to run receiver for case2" << std::endl;
                return result;
            }
        }
        else {
        ...
        if (role == "sender") {
            int result = start_sender_case3();
            if (result != 0) {
                std::cerr << "Failed to run sender for case3" << std::endl;
                return result;
            }
        }
        else if (role == "receiver") {
            int result = start_receiver_case3();
            if (result != 0) {
                std::cerr << "Failed to run receiver for case3" << std::endl;
                return result;
            }
        }
        else {
        ...
        if (role == "sender") {
            int result = start_sender(remote_ip);
            if (result != 0) {
